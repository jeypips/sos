...
$header = array(
	function($p) {
		...
		$p->Cell(0,5,"CASUAL EMPLOYEES",0,1,'C');	
	},
...
$headers = array(
	array("width"=>15,"column"=>"No"),
	array("width"=>70,"column"=>"Name of Personnel"),
	array("width"=>20,"column"=>"Sex"),
	array("width"=>20,"column"=>"Office"),
	array("width"=>70,"column"=>"CS Eligibility"),	
	array("width"=>30,"column"=>"No. of Years of Service as JO/CO/MOA personnel"),
	array("width"=>30,"column"=>"Nature of Work")
);
...
$data = $con->getData("SELECT employee_id,(CONCAT(employee_firstname,' ',employee_middlename,' ',employee_lastname)
      ) AS employee_fullname, employee_gender, employee_department, '' cs_eligibility, '' no_of_years_of_service, '' nature_of_work FROM personal_infos");
