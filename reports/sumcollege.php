...
$headers = array(
	...
	array("width"=>40,"column"=>"Full Name"),
	array("width"=>50,"column"=>"Educational Level"),
	array("width"=>25,"column"=>"Year"),
	array("width"=>25,"column"=>"Course"),
	array("width"=>45,"column"=>"Number of Offenses")
);
...
$sql = "SELECT id_number, CONCAT(firstname,' ',lastname) fullname, educational_level, year, course,(SELECT SUM(com_service) FROM offenses) total FROM students $filter";
