...
$headers = array(
	...
	array("width"=>60,"column"=>"Educational Level"),
	array("width"=>60,"column"=>"Grade"),
	array("width"=>60,"column"=>"Section")
);
...
$sql = "SELECT id_number, educational_level, grade, section FROM students $filter";
