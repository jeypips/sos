...
if (isset($_POST['offense']['inc_uniform'],$_POST['offense']['late_tardy'],$_POST['offense']['absent'],$_POST['offense']['no_id'],$_POST['offense']['cutting_classes'],$_POST['offense']['recom_others_cb'],$_POST['offense']['recom_others_cb'],$_POST['offense']['admitted_excuse'],$_POST['offense']['admitted_notexcuse'],$_POST['offense']['academic_loses'],$_POST['offense']['completion_required'],$_POST['offense']['dropped'],$_POST['offense']['parent_notification']))    
{    
